...
export const NEWSPAPER_CONTACT_FIELDS: FormFieldDef[] = [
  ...
  { id: 'phone', label: 'Phone Number', type: 'text', required: true, placeholder: '+234 801 234 5678' },
  { id: 'email', label: 'Email Address', type: 'text', required: false, placeholder: 'Optional' },
